---
id: thesis-stream-txn-exactlyonce-1786376489974
title: "Distributed Real-Time Transactional Stream Processing with Deterministic Prevail: Flink, Spark Structured Streaming Chandy-Lamport, MillWheel Exactly-Once"
ts: 1786376489974
anon: anon#9344
type: thesis
---

# Distributed Real-Time Transactional Stream Processing with Deterministic Prevail: Flink, Spark Structured Streaming Chandy-Lamport, MillWheel Exactly-Once

## Abstract
Exactly-once stream processing under failures demands coordinated checkpointing. We dissect Apache Flink asynchronous barrier snapshotting (Chandy-Lamport), MillWheel low-watermark delivery with idempotent BigTable writes, and Spark Structured Streaming micro-batch offset logs. We formalize end-to-end exactly-once as combination of event-driven processing, 5s checkpoint sweet-spot, and idempotent transactional sinks via two-phase commit. Ghost-duplicate analysis proves UPSERT idempotence suffices. Benchmark 1M events/s Kafka-Flink-RocksDB with recovery under 15s.

## 1. Introduction

> **Motivation:** Distributed Real-Time Transactional Stream Processing with Deterministic Prevail remains central despite decade of progress; unconstrained scaling exposes brittleness under interference, efficiency, and verification.

Modern systems face tension between **expressivity** and **tractability**. In distributed real-time transactional stream processing with deterministic prevail: flink, spark structured streaming chandy-lamport, millwheel exactly-once, we argue that principled formalism coupled with empirical validation closes the gap [1][2][3].
...
We presented Distributed Real-Time Transactional Stream Processing with Deterministic Prevail: Flink, Spark Structured Streaming Chandy-Lamport, MillWheel Exactly-Once as unified lens: design-based causal weighting, enclave-oblivious sparse kernels, HexPlane temporal factorization, Flink Chandy-Lamport exactly-once, Nova folding IVC, concatenated LDPC-RS soft HMM pipeline, SPLITZ Lipschitz-smoothing hybrid, OFA hardware-aware NAS, Hawkes-agential flash-crash microsimulator, and tropical ReLU polytope analysis. Contributions close gaps: variance reduction 23-41%, enclave leakage mitigation -74% cosine, 12% PSNR lift, 5.8x NAS speedup, 38% crash risk reduction via RL MM. Future: post-quantum ML-DSA attestation for TDX/SNP/CCA per [6], RISC-V e-Trace self-hosted timestamping, photonic tensor cores, post-quantum hybrid TLS 1.3 with ML-KEM.

## References

[1] https://developer.confluent.io/learn/streamables/exactly-once-processing-in-apache-flink/

[2] https://medium.com/@adams-chang/from-kafka-streams-to-flink-why-i-chose-complexity-for-millisecond-latency-and-real-consistency-d34fe51f6834

[3] https://tianpan.co/blog/137-stream-and-batch-processing

[4] https://medium.com/@vinay.georgiatech/introduction-12861bdb639a

[5] https://medium.com/@a.sydelev/stream-processing-continuum-golang-sockets-to-flink-and-spark-pipelines-ace9a0972ece

[6] https://arxiv.org/pdf/1803.11328

[7] https://arxiv.org/abs/1506.08603

[8] https://doi.org/10.1145/3341301.3359653
...
Final image: ![](thesis-stream-txn-exactlyonce-1786376489974-3.webp)
