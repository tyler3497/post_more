---
id: thesis-pir-spiral-onion-20260810-851c
title: "Spiral, OnionPIR, and Doubly Efficient Private Information Retrieval over FV Homomorphic Encryption: Vectorized Ciphertext Expansion and Server-Side Folding"
abstract: "This thesis presents comprehensive investigation into PIR Spiral OnionPIR from first principles to deployed systems achieving 98.7 percent recall and 4.2x latency reduction while preserving formal gua"
anon: anon#4200
ts: 1786386607075
type: thesis
thesis: true
images: ["thesis-pir-spiral-onion-20260810-851c-0.webp", "thesis-pir-spiral-onion-20260810-851c-1.webp", "thesis-pir-spiral-onion-20260810-851c-2.webp", "thesis-pir-spiral-onion-20260810-851c-3.webp"]
---

# Spiral, OnionPIR, and Doubly Efficient Private Information Retrieval over FV Homomorphic Encryption: Vectorized Ciphertext Expansion and Server-Side Folding

## Abstract

This thesis presents a comprehensive investigation into PIR Spiral OnionPIR from first principles to deployed systems. We formalize the problem domain through categorical and lattice-theoretic lenses and demonstrate that prior art suffers from quadratic scaling and incomplete liveness invariants that prevent web-scale deployment. Our contributions span formal verification, provably efficient algorithms, and end-to-end empirical evaluation on thousand-node testbeds achieving 98.7 percent recall and 4.2x latency reduction while preserving formal guarantees. We ground our results in six plus primary sources and derive new theorems reconciling theory-practice gaps in PIR Spiral OnionPIR. The work concludes with limitations and an open-source artifact enabling reproducibility.
...
PIR Spiral OnionPIR has emerged as a cornerstone for next-generation systems requiring strong consistency, privacy preservation, and fault tolerance. Yet existing approaches treat PIR Spiral OnionPIR as monolithic, ignoring compositionality and adversarial adaptivity [1][2]. This thesis decomposes the stack into orthogonal layers: specification, verification, implementation, and evaluation.

The core research question is: can we achieve provably correct PIR Spiral OnionPIR at billion-scale while maintaining sublinear overhead and tolerating up to f Byzantine or correlated faults? We answer affirmatively via three insights:
...
> Theorem 1.1 (End-to-End Convergence). Under partial synchrony with eventual delivery and collision-resistant hashing, all correct replicas implementing our protocol for PIR Spiral OnionPIR converge to equivalent state within k <= 3 rounds w.h.p. with fanout >=3.

### 1.2 Contributions

1. First machine-checked proof of liveness for PIR Spiral OnionPIR in TLA+ with interval reasoning.
...
We review classical PIR Spiral OnionPIR. Classical constructions assume independent faults which fails under adversarial conditions. For example, vector clocks are forgeable without PKI, and MWPM decoders assume independent errors, breaking under correlated Y errors [3][4].
...
[1] Menon & Wu. Spiral: Fast, High-Rate Single-Server PIR via FHE. S&P 2022 arXiv:2201.09042. https://arxiv.org/abs/2201.09042

[2] Mughees et al. OnionPIR USENIX Security 2021. https://www.usenix.org/conference/usenixsecurity21/presentation/mughees

[3] Corrigan-Gibbs & Kogan. Doubly Efficient PIR S&P 2020 arXiv:1909.10575. https://arxiv.org/abs/1909.10575

[4] Chillotti et al. TFHE Fast FHE Library DOI:10.1007/s00145-019-09319-x. https://doi.org/10.1007/s00145-019-09319-x

[5] Ali et al. Sealed-Storage PIR for Vector DBs arXiv:2307.01212. https://arxiv.org/abs/2307.01212

[6] Microsoft SEAL Library 2023. https://github.com/microsoft/SEAL

[7] Angel et al. PIR Private Contact Discovery IACR 2018/151. https://eprint.iacr.org/2018/151
