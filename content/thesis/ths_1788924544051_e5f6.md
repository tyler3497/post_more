...
4. **One-shot computation.** Most circuits consume their fuel and gates; the computation cannot be reset without synthesizing fresh components (renewable designs exist but add substantial complexity). There is no molecular equivalent of a clocked, reprogrammable processor—yet.
