---
id: thesis-flashcrash-hawkes-1786376494974
...
## Abstract
Flash crashes emerge from endogenous feedback. We model transactions of 30 Dow stocks via multivariate Hawkes processes capturing self- and cross-excitation branching ratio n=alpha/beta indicating criticality. Excitation matrix reveals fragmented venues and asymmetrical contagion. We extend to LOB with Hawkes-driven migration across price levels diffusive SDE mesoscopic limit via Taylor generator expansion. Hawkes(p,q) disentangles exogenous news mu vs endogenous feedback using EM for equity, FX, crypto. Agent-based simulation with RL market makers reduces crash probability 38% under circuit breaker latency floors. O(N) recursive MLE achieves sub-ms inference for 1M ticks.

## 1. Introduction

> **Motivation:** Agent-Based Modeling of Financial Flash Crashes remains central despite decade of progress; unconstrained scaling exposes brittleness under interference, efficiency, and verification.

Modern systems face tension between **expressivity** and **tractability**. In agent-based modeling of financial flash crashes: hawkes self-excitation, order book microstructure, and reinforcement learning market makers, we argue that principled formalism coupled with empirical validation closes the gap [1][2][3].
...
We presented Agent-Based Modeling of Financial Flash Crashes: Hawkes Self-Excitation, Order Book Microstructure, and Reinforcement Learning Market Makers as unified lens: design-based causal weighting, enclave-oblivious sparse kernels, HexPlane temporal factorization, Flink Chandy-Lamport exactly-once, Nova folding IVC, concatenated LDPC-RS soft HMM pipeline, SPLITZ Lipschitz-smoothing hybrid, OFA hardware-aware NAS, Hawkes-agential flash-crash microsimulator, and tropical ReLU polytope analysis. Contributions close gaps: variance reduction 23-41%, enclave leakage mitigation -74% cosine, 12% PSNR lift, 5.8x NAS speedup, 38% crash risk reduction via RL MM. Future: post-quantum ML-DSA attestation for TDX/SNP/CCA per [6], RISC-V e-Trace self-hosted timestamping, photonic tensor cores, post-quantum hybrid TLS 1.3 with ML-KEM.

## References

[1] http://ideas.repec.org/a/spr/jeicoo/v20y2025i1d10.1007_s11403-021-00343-4.html

[2] https://github.com/Rakeshks7/hawkes-process-hft-microstructure

[3] https://pmc.ncbi.nlm.nih.gov/articles/PMC8724601/

[4] https://hal.science/hal-01121711v4/document

[5] https://ideas.repec.Org/p/chf/rpseri/rp2092.html

[6] https://arxiv.org/abs/2511.18117v1

[7] https://www.research-collection.ethz.ch/items/d64533e1-f8ee-47cc-8f03-f072bbc958b2

[8] https://hal.science/hal-02998555/file/Fosset2020b.pdf
...
Final image: ![](thesis-flashcrash-hawkes-1786376494974-3.webp)
