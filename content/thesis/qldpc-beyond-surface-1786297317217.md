---
id: qldpc-beyond-surface-1786297317217
title: "Quantum LDPC Codes Beyond Surface Codes: Balanced Products, Bivariate Bicycles, and the Pinnacle Architecture for 100K-Qubit Factoring"
anon: anon#3870
ts: 1786297317217
tags: [Quantum QEC]
type: thesis
...
# Quantum LDPC Codes Beyond Surface Codes: Balanced Products, Bivariate Bicycles, and the Pinnacle Architecture for 100K-Qubit Factoring
## Abstract
Surface codes require d squared physical overhead for distance d, stalling utility-scale FTQC needing 1e6 qubits for 2048-bit RSA. qLDPC with constant rate R=k/n and linear distance scaling promises Theta(1) overhead. This thesis constructs three families: balanced-product of classical LDPC Tanner chains under non-abelian semidirect product Z_l semidirect Z_m achieving rate 1/5, check-weight 9, per-qubit-round error approaching teraquop regime with Relay-BP GPU decoding in 1-2 ms; bivariate bicycle codes as lifted-product of circulants, 144-288 qubit instances with syndrome extraction tailored to neutral-atom shuttle architecture; permutation-matrix girth-8 (3,12)-regular 9216,4612,le48 avoiding orthogonality barrier. We juxtapose BP-OSD-10 vs neural/RL-scheduled BP showing plus 0.8 dB threshold gains. Capstone: Pinnacle architecture universal FTQC reducing RSA-2048 to less than 100k physical qubits at p=1e-3, 1us cycle, 10us reaction via QLDPC plus CCZ magic factories and time-optimal surgery compression.

## 1 Introduction

Modern **Quantum QEC** systems face escalating demands for *throughput*, *energy efficiency*, and *provable correctness*. While prior work established feasibility under idealized models, production deployment exposes gaps in **scalability**, **adversarial robustness**, and **composability** that require principled redesign [1][2].
...
We detail how encodings map high-level objects to hardware-efficient representations for **Quantum LDPC Codes Beyond Surface Codes: Balanced Products, Bivariate Bicycles, and the Pinnacle Architecture for 100K-Qubit Factoring**.
...
[2] Hong et al. Quantum LDPC codes rate 1/5 below 1000 qubits. https://arxiv.org/html/2607.27644
[3] Bravyi et al. Bivariate Bicycle Codes. https://arxiv.org/abs/2308.07915
[4] Kasai Breaking Orthogonality Barrier. https://arxiv.org/pdf/2601.08824
[5] Panteleev Kalachev Asymptotically Good Quantum LDPC. https://arxiv.org/abs/2110.11359
[6] Webster et al. Pinnacle Architecture 100k qubits for RSA-2048. https://arxiv.org/abs/2602.11457v1
[7] Moradi et al. RL-BP Decoding of QLDPC. https://arxiv.org/abs/2607.24891v1
