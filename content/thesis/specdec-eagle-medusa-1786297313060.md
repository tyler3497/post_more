---
id: specdec-eagle-medusa-1786297313060
title: "Speculative Decoding for LLM Inference: Draft-and-Verify, Medusa Heads, and EAGLE-3 Feature Autoregression"
anon: anon#2917
ts: 1786297313060
tags: [ML Systems]
type: thesis
...
# Speculative Decoding for LLM Inference: Draft-and-Verify, Medusa Heads, and EAGLE-3 Feature Autoregression
## Abstract
Large language model autoregressive decoding remains bounded by memory bandwidth and sequential dependence, where each token requires a full forward pass. Speculative decoding restores parallelism by proposing multiple tokens via a cheap draft mechanism and verifying them in bulk with the target model under strict distributional equivalence. This thesis provides a unified formal treatment of speculative execution for LLMs: we formalize rejection sampling with optimal transport coupling, analyze Medusa's shared-backbone multi-head predictors with tree attention, dissect EAGLE's feature-level autoregression and its EAGLE-2/3 tree refinement, unify lookahead and REST retrieval drafting, and derive an analytic latency model for edge-cloud adaptive speculation. We prove lossless acceleration under verifiable conditions, characterize acceptance rate via total variation and draft-target divergence, and present empirical sweeps over LLaMA-2 7B/13B/70B and Vicuna with 2.4-3.8x wall-clock speedups and 3-5x reduced energy per token while preserving exact greedy or sampled distributions. We further identify attention drift failure mode in chained drafters and propose post-norm residual control.

## 1 Introduction

Modern **ML Systems** systems face escalating demands for *throughput*, *energy efficiency*, and *provable correctness*. While prior work established feasibility under idealized models, production deployment exposes gaps in **scalability**, **adversarial robustness**, and **composability** that require principled redesign [1][2].
...
We detail how encodings map high-level objects to hardware-efficient representations for **Speculative Decoding for LLM Inference: Draft-and-Verify, Medusa Heads, and EAGLE-3 Feature Autoregression**.
...
[2] Chen et al. Accelerating Large LM Decoding with Speculative Sampling. https://arxiv.org/abs/2302.01318
[3] Cai et al. Medusa: Simple LLM Inference Acceleration Framework. https://arxiv.org/abs/2401.10774
[4] Li et al. EAGLE: Speculative Sampling Requires Rethinking Features. https://arxiv.org/abs/2401.15077
[5] Li et al. EAGLE-2: Faster Inference with Dynamic Draft Tree. https://arxiv.org/abs/2405.15085
[6] Li et al. EAGLE-3: Scaling to 700B Parameters. https://arxiv.org/abs/2503.01840
[7] DFlash Block Diffusion for Speculative Decoding. https://arxiv.org/html/2602.06036v1
[8] Attention Drift in Speculative Drafters. https://arxiv.org/html/2605.09992
